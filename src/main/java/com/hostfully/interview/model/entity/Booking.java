...
public class Booking {
    ...
    @Schema(description = "When the booking was created", example = "New Unit", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotNull
    private LocalDate createdAt;

    @Schema(description = "When the last time the booking was updated", example = "New Unit")
